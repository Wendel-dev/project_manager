...
import { ProjectRepository } from "./Main/infrastructure/ProjectRepository";
import { TaskRepository } from "./Main/infrastructure/TaskRepository";
import { DocRepository } from "./Main/infrastructure/DocRepository";
import { PhaseRepository } from "./Main/infrastructure/PhaseRepository";
import { AddProjectUseCase } from "./Main/application/AddProjectUseCase";
import { UpdateProjectUseCase } from "./Main/application/UpdateProjectUseCase";
import { DeleteProjectUseCase } from "./Main/application/DeleteProjectUseCase";
import { GetTasksUseCase } from "./Main/application/GetTasksUseCase";
import { AddTaskUseCase } from "./Main/application/AddTaskUseCase";
import { UpdateTaskUseCase } from "./Main/application/UpdateTaskUseCase";
import { DeleteTaskUseCase } from "./Main/application/DeleteTaskUseCase";
import { SaveDocUseCase } from "./Main/application/SaveDocUseCase";
import { GetGovernanceUseCase } from "./Main/application/GetGovernanceUseCase";
import { ParseDocumentUseCase } from "./Main/application/ParseDocumentUseCase";
import { ImportTasksUseCase } from "./Main/application/ImportTasksUseCase";
import { CreatePhaseUseCase } from "./Main/application/CreatePhaseUseCase";
import { ParseDocDocumentUseCase } from "./Main/application/ParseDocDocumentUseCase";
import { ImportDocUseCase } from "./Main/application/ImportDocUseCase";
import { GetDocTreeUseCase } from "./Main/application/GetDocTreeUseCase";
import { DocMarkdownParser } from "./Main/infrastructure/parsers/DocMarkdownParser";
import { DocTextParser } from "./Main/infrastructure/parsers/DocTextParser";
import { DocPDFParser } from "./Main/infrastructure/parsers/DocPDFParser";
